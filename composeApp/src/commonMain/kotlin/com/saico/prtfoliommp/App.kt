...
import com.saico.prtfoliommp.feature.resumeScreen.ResumeScreen
                ...
                Scaffold(
                    ...
                    topBar = {
                        if (windowSizeClass == WindowSizeClass.Expanded || windowSizeClass == WindowSizeClass.Medium) {
                            ...
                            Row(
                                modifier = Modifier.fillMaxWidth().padding(top = 32.dp, end = 8.dp),
                    ...
                    when (currentScreen) {
                        ...
                        Screen.Resume -> ResumeScreen(windowSizeClass = windowSizeClass) // Needs to be adapted
